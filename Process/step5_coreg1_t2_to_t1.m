...
if patnum == 101 || patnum == 102 || patnum == 133
    i_t2_nii_fn = msf_find_fn(ip_raw, '*t2_tirm_tra_dark*', 0);
elseif patnum == 119 || patnum == 132
    i_t2_nii_fn = msf_find_fn(ip_raw, '*t2_spc_da-fl_sag*', 0);
elseif patnum == 155 && strcmp(s.exam_name, '20200317_1')
    i_t2_nii_fn = msf_find_fn(ip_raw, 'Serie_02_t2_spc_da-fl_sag_fs.nii.gz', 0);
elseif (patnum == 164 && strcmp(s.exam_name, '20201008_1')) || (patnum == 165 && strcmp(s.exam_name, '20200820_1')) ...
        || (patnum == 165 && strcmp(s.exam_name, '20200924_1')) || (patnum >= 168 && patnum <= 176)
...
if (patnum == 158 && strcmp(s.exam_name, '20200428_1)')) || patnum == 161 || (patnum == 155 && strcmp(s.exam_name, '20200317_1'))
